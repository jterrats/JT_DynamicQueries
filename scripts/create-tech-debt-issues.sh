#!/bin/bash
# Script to create GitHub issues for Technical Debt items
# Requires: GitHub CLI (gh) installed and authenticated
# Based on: docs/TECH_DEBT.md
...
# Issue 1: Husky Pre-commit Hook Scanner Permissions
echo "Creating Issue #1: Husky Pre-commit Hook Scanner Permissions..."
gh issue create \
  --title "[Tech Debt] Fix Husky Pre-commit Hook Scanner Permissions" \
  --label "bug,tech-debt,high-priority,infrastructure" \
  --body "## 🔴 High Priority Tech Debt
...
echo "Creating Issue #2: Remove Deprecated Methods..."
gh issue create \
  --title "[Tech Debt] Remove Deprecated Methods and Migrate Callers" \
  --label "tech-debt,high-priority,refactoring" \
  --body "## 🔴 High Priority Tech Debt
...
echo "Creating Issue #3: Remove Legacy Code Paths..."
gh issue create \
...
echo "Creating Issue #4: Complete Setup Wizard Tests..."
gh issue create \
  --title "[Tech Debt] Complete Setup Wizard Test Coverage" \
  --label "tech-debt,medium-priority,testing" \
  --body "## 🟡 Medium Priority Tech Debt
...
echo "Creating Issue #5: Fix Accessibility Issues..."
gh issue create \
  --title "[Tech Debt] Fix Accessibility Test Issues and Implement Missing Features" \
  --label "tech-debt,medium-priority,accessibility,testing" \
  --body "## 🟡 Medium Priority Tech Debt
...
echo "Creating Issue #6: Update Outdated Test Comments..."
gh issue create \
  --title "[Tech Debt] Update Outdated Test Comments" \
  --label "tech-debt,low-priority,documentation" \
  --body "## 🟢 Low Priority Tech Debt
...
# Issue 7: Add Favicon
echo "Creating Issue #7: Add Favicon Assets..."
gh issue create \
  --title "[Tech Debt] Add Favicon to Documentation Site" \
  --label "tech-debt,low-priority,ui/ux,documentation" \
  --body "## 🟢 Low Priority Tech Debt
...
echo "Creating Issue #8: Clean Up Obsolete Code Comments..."
gh issue create \
...
echo "Creating Issue #9: Improve Test Data with Realistic Salesforce IDs..."
gh issue create \
  --title "[Tech Debt] Replace Placeholder IDs with Realistic Salesforce ID Formats" \
  --label "tech-debt,low-priority,testing" \
  --body "## 🟢 Low Priority Tech Debt
...
echo "Creating Issue #10: Extract Hardcoded Values to Constants..."
gh issue create \
  --title "[Tech Debt] Extract Hardcoded Values to Configuration Constants" \
  --label "tech-debt,low-priority,refactoring" \
  --body "## 🟢 Low Priority Tech Debt
...
echo ""
echo "✅ All tech debt issues created successfully!"
echo ""
echo "📋 Summary:"
echo "   - High Priority: 3 issues"
echo "   - Medium Priority: 2 issues"
echo "   - Low Priority: 5 issues"
echo ""
echo "🔗 View issues: https://github.com/jterrats/JT_DynamicQueries/issues"
