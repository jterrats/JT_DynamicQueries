/**
 * Dynamic Query Framework - Translations
...
export const content = {
  en: {
    ...
    runAsUserDesc:
      "Execute queries as different users to test permissions and data visibility. Perfect for admins validating security models.",
    ...
    feature4Desc: "WCAG 2.1 AA compliant with full keyboard navigation",
    feature5Title: "🎨 Lightning Design",
    feature5Desc: "Built with Salesforce Lightning Design System",
    ...
    footerText: "Built with ❤️ by",
    license: "Licensed under MIT | © 2025"
  },
  es: {
    bannerText: "Así se verá el sitio de GitHub Pages",
    title: "⚡ Dynamic Query Framework",
    tagline:
    ...
    githubPages: "GitHub Pages",
    allDocsValid: "Todos los Docs Válidos",
    coverage: "Cobertura",
    codeCoverage: "Cobertura de Código",
    demos: "🎬 Míralo en Acción",
    queryExecution: "⚡ Ejecución de Consultas",
    queryExecutionDesc:
      "Selecciona una configuración y ejecuta consultas instantáneamente. Ve los resultados en una tabla intuitiva con desplazamiento suave.",
    multipleViews: "📊 Múltiples Vistas",
    multipleViewsDesc:
      "Cambia entre vistas de Tabla, JSON y CSV sin problemas. Exporta datos en tu formato preferido para análisis o integración.",
    treeView: "🌳 Vista de Árbol",
    treeViewDesc:
      "Expande registros padre para ver relaciones hijo en una estructura jerárquica. Perfecto para navegar modelos de datos complejos.",
    largeDatasets: "🚀 Conjuntos de Datos Grandes",
    largeDatasetsDesc:
      "Maneja conjuntos de datos masivos (>50k registros) con paginación basada en cursores. Rendimiento optimizado para consultas a escala empresarial.",
    createConfig: "⚙️ Crear Configuración",
    createConfigDesc:
      "Construye configuraciones de consultas personalizadas con un formulario simple. Define objetos, campos, filtros y parámetros en segundos.",
    runAsUser: "👤 Ejecutar Como Usuario",
    runAsUserDesc:
      "Ejecuta consultas como diferentes usuarios para probar permisos y visibilidad de datos. Perfecto para administradores validando modelos de seguridad.",
    features: "✨ Características Clave",
    feature1Title: "🚀 Consultas Dinámicas",
    feature1Desc: "Ejecuta consultas SOQL dinámicamente sin hardcodear",
    feature2Title: "🔐 Named Credentials",
    feature2Desc:
      "Llamadas seguras a Tooling API con Named Credentials modernos",
  ...
  fr: {
    bannerText: "Voici à quoi ressemblera le site GitHub Pages",
    title: "⚡ Dynamic Query Framework",
    tagline:
    ...
    githubPages: "GitHub Pages",
    allDocsValid: "Tous les Docs Valides",
    coverage: "Couverture",
    codeCoverage: "Couverture de Code",
    demos: "🎬 Voyez-le en Action",
    queryExecution: "⚡ Exécution de Requête",
    queryExecutionDesc:
      "Sélectionnez une configuration et exécutez des requêtes instantanément. Visualisez les résultats dans un tableau intuitif avec défilement fluide.",
    multipleViews: "📊 Vues Multiples",
    multipleViewsDesc:
      "Basculez entre les vues Tableau, JSON et CSV de manière transparente. Exportez les données dans votre format préféré pour l'analyse ou l'intégration.",
    treeView: "🌳 Vue Arborescente",
    treeViewDesc:
      "Développez les enregistrements parents pour voir les relations enfants dans une structure hiérarchique. Parfait pour naviguer dans des modèles de données complexes.",
    largeDatasets: "🚀 Grands Ensembles de Données",
    largeDatasetsDesc:
      "Gérez des ensembles de données massifs (>50k enregistrements) avec pagination basée sur curseur. Performance optimisée pour les requêtes d'entreprise.",
    createConfig: "⚙️ Créer une Configuration",
    createConfigDesc:
      "Créez des configurations de requête personnalisées avec un formulaire simple. Définissez objets, champs, filtres et paramètres en quelques secondes.",
    runAsUser: "👤 Exécuter en tant qu'Utilisateur",
    runAsUserDesc:
      "Exécutez des requêtes en tant que différents utilisateurs pour tester les permissions et la visibilité des données. Parfait pour les administrateurs validant les modèles de sécurité.",
    features: "✨ Fonctionnalités Clés",
    feature1Title: "🚀 Requêtes Dynamiques",
    feature1Desc: "Exécutez des requêtes SOQL dynamiquement sans codage en dur",
    feature2Title: "🔐 Named Credentials",
    feature2Desc:
      "Appels API Tooling sécurisés avec Named Credentials modernes",
    feature3Title: "📊 Vues Multiples",
    feature3Desc: "Basculez entre Tableau, JSON et vues de cartes mobiles",
    feature4Title: "♿ Accessible",
    feature4Desc: "Conforme WCAG 2.1 AA avec navigation clavier complète",
    feature5Title: "🎨 Design Lightning",
    feature5Desc: "Construit avec Salesforce Lightning Design System",
    feature6Title: "🧪 Testé",
  ...
  de: {
    bannerText: "So wird die GitHub Pages-Site aussehen",
    title: "⚡ Dynamic Query Framework",
    tagline:
    ...
    githubPages: "GitHub Pages",
    allDocsValid: "Alle Docs Gültig",
    coverage: "Abdeckung",
    codeCoverage: "Code-Abdeckung",
    demos: "🎬 Sehen Sie es in Aktion",
    queryExecution: "⚡ Abfrageausführung",
    queryExecutionDesc:
      "Wählen Sie eine Konfiguration aus und führen Sie Abfragen sofort aus. Zeigen Sie Ergebnisse in einem intuitiven Tabellenformat mit flüssigem Scrollen an.",
    multipleViews: "📊 Mehrere Ansichten",
    multipleViewsDesc:
      "Wechseln Sie nahtlos zwischen Tabellen-, JSON- und CSV-Ansichten. Exportieren Sie Daten in Ihrem bevorzugten Format für Analyse oder Integration.",
    treeView: "🌳 Baumansicht",
    treeViewDesc:
      "Erweitern Sie übergeordnete Datensätze, um untergeordnete Beziehungen in einer hierarchischen Baumstruktur anzuzeigen. Perfekt für die Navigation in komplexen Datenmodellen.",
    largeDatasets: "🚀 Große Datensätze",
    largeDatasetsDesc:
      "Verarbeiten Sie massive Datensätze (>50k Datensätze) mit cursorbasierter Paginierung. Optimierte Leistung für Unternehmensabfragen.",
    createConfig: "⚙️ Konfiguration Erstellen",
    createConfigDesc:
      "Erstellen Sie benutzerdefinierte Abfragekonfigurationen mit einem einfachen Formular. Definieren Sie Objekte, Felder, Filter und Parameter in Sekunden.",
    runAsUser: "👤 Als Benutzer Ausführen",
    runAsUserDesc:
      "Führen Sie Abfragen als verschiedene Benutzer aus, um Berechtigungen und Datensichtbarkeit zu testen. Perfekt für Administratoren, die Sicherheitsmodelle validieren.",
    ...
    feature5Title: "🎨 Lightning-Design",
    feature5Desc: "Erstellt mit Salesforce Lightning Design System",
    ...
    footerText: "Mit ❤️ erstellt von",
    license: "MIT-Lizenz | © 2025"
  },
  it: {
    ...
    githubPages: "GitHub Pages",
    allDocsValid: "Tutti i Doc Validi",
    coverage: "Copertura",
    codeCoverage: "Copertura del Codice",
    demos: "🎬 Guardalo in Azione",
    queryExecution: "⚡ Esecuzione Query",
    queryExecutionDesc:
      "Seleziona una configurazione ed esegui query istantaneamente. Visualizza i risultati in un formato tabella intuitivo con scorrimento fluido.",
    multipleViews: "📊 Viste Multiple",
    multipleViewsDesc:
      "Passa tra viste Tabella, JSON e CSV senza problemi. Esporta dati nel tuo formato preferito per analisi o integrazione.",
    treeView: "🌳 Vista Ad Albero",
    treeViewDesc:
      "Espandi record padre per visualizzare relazioni figlio in una struttura gerarchica ad albero. Perfetto per navigare modelli di dati complessi.",
    largeDatasets: "🚀 Dataset Grandi",
    largeDatasetsDesc:
      "Gestisci dataset massicci (>50k record) con paginazione basata su cursore. Prestazioni ottimizzate per query su scala aziendale.",
    createConfig: "⚙️ Crea Configurazione",
    createConfigDesc:
      "Crea configurazioni di query personalizzate con un form semplice. Definisci oggetti, campi, filtri e parametri in secondi.",
    runAsUser: "👤 Esegui Come Utente",
    runAsUserDesc:
      "Esegui query come utenti diversi per testare permessi e visibilità dei dati. Perfetto per amministratori che validano modelli di sicurezza.",
    ...
    feature4Desc: "Conforme WCAG 2.1 AA con navigazione tastiera completa",
    feature5Title: "🎨 Design Lightning",
    feature5Desc: "Costruito con Salesforce Lightning Design System",
  ...
  ja: {
    ...
    githubPages: "GitHub Pages",
    allDocsValid: "全ドキュメント有効",
    coverage: "カバレッジ",
    codeCoverage: "コードカバレッジ",
    demos: "🎬 実際に見る",
    queryExecution: "⚡ クエリ実行",
    queryExecutionDesc:
      "構成を選択してクエリを即座に実行します。直感的なテーブル形式でスムーズなスクロールで結果を表示します。",
    multipleViews: "📊 複数のビュー",
    multipleViewsDesc:
      "テーブル、JSON、CSVビューをシームレスに切り替えます。分析や統合のために好みの形式でデータをエクスポートします。",
    treeView: "🌳 ツリービュー",
    treeViewDesc:
      "親レコードを展開して、階層的なツリー構造で子関係を表示します。複雑なデータモデルのナビゲーションに最適です。",
    largeDatasets: "🚀 大規模データセット",
    largeDatasetsDesc:
      "カーソルベースのページネーションで大規模なデータセット（>50kレコード）を処理します。エンタープライズ規模のクエリに最適化されたパフォーマンス。",
    createConfig: "⚙️ 構成を作成",
    createConfigDesc:
      "シンプルなフォームでカスタムクエリ構成を作成します。オブジェクト、フィールド、フィルター、パラメーターを数秒で定義します。",
    runAsUser: "👤 ユーザーとして実行",
    runAsUserDesc:
      "異なるユーザーとしてクエリを実行して、権限とデータの可視性をテストします。セキュリティモデルを検証する管理者に最適です。",
    features: "✨ 主な機能",
    feature1Title: "🚀 動的クエリ",
    ...
    feature4Desc: "完全なキーボードナビゲーションでWCAG 2.1 AA準拠",
    feature5Title: "🎨 Lightningデザイン",
    feature5Desc: "Salesforce Lightning Design Systemで構築",
    feature6Title: "🧪 テスト済み",
    ...
    footerText: "❤️で作成",
    license: "MITライセンス | © 2025"
  },
  pt: {
    bannerText: "É assim que o site do GitHub Pages ficará",
    title: "⚡ Dynamic Query Framework",
    tagline:
    ...
    githubPages: "GitHub Pages",
    allDocsValid: "Todos os Docs Válidos",
    coverage: "Cobertura",
    codeCoverage: "Cobertura de Código",
    demos: "🎬 Veja em Ação",
    queryExecution: "⚡ Execução de Consulta",
    queryExecutionDesc:
      "Selecione uma configuração e execute consultas instantaneamente. Visualize resultados em um formato de tabela intuitivo com rolagem suave.",
    multipleViews: "📊 Múltiplas Visualizações",
    multipleViewsDesc:
      "Alterne entre visualizações de Tabela, JSON e CSV perfeitamente. Exporte dados no seu formato preferido para análise ou integração.",
    treeView: "🌳 Visualização em Árvore",
    treeViewDesc:
      "Expanda registros pai para visualizar relacionamentos filho em uma estrutura hierárquica em árvore. Perfeito para navegar em modelos de dados complexos.",
    largeDatasets: "🚀 Conjuntos de Dados Grandes",
    largeDatasetsDesc:
      "Manipule conjuntos de dados massivos (>50k registros) com paginação baseada em cursor. Desempenho otimizado para consultas em escala empresarial.",
    createConfig: "⚙️ Criar Configuração",
    createConfigDesc:
      "Construa configurações de consulta personalizadas com um formulário simples. Defina objetos, campos, filtros e parâmetros em segundos.",
    runAsUser: "👤 Executar Como Usuário",
    runAsUserDesc:
      "Execute consultas como diferentes usuários para testar permissões e visibilidade de dados. Perfeito para administradores validando modelos de segurança.",
    features: "✨ Recursos Principais",
    feature1Title: "🚀 Consultas Dinâmicas",
    feature1Desc: "Execute consultas SOQL dinamicamente sem codificação fixa",
    feature2Title: "🔐 Named Credentials",
    feature2Desc:
    ...
    footerText: "Feito com ❤️ por",
    license: "Licença MIT | © 2025"
  },
  zh: {
    bannerText: "GitHub Pages 网站将如此展示",
    title: "⚡ Dynamic Query Framework",
    ...
    queryExecution: "⚡ 查询执行",
    queryExecutionDesc:
      "选择配置并立即执行查询。以直观的表格格式和流畅的滚动查看结果。",
    multipleViews: "📊 多视图",
    multipleViewsDesc:
      "无缝切换表格、JSON和CSV视图。以您喜欢的格式导出数据进行分析或集成。",
    treeView: "🌳 树视图",
    treeViewDesc:
      "展开父记录以在层次树结构中查看子关系。非常适合浏览复杂的数据模型。",
    largeDatasets: "🚀 大型数据集",
    largeDatasetsDesc:
      "使用基于游标的分页处理海量数据集（>50k记录）。针对企业规模查询优化的性能。",
    createConfig: "⚙️ 创建配置",
    createConfigDesc:
      "使用简单的表单构建自定义查询配置。在几秒钟内定义对象、字段、过滤器和参数。",
    runAsUser: "👤 以用户身份运行",
    runAsUserDesc:
      "以不同用户身份执行查询以测试权限和数据可见性。非常适合验证安全模型的管理员。",
    features: "✨ 主要功能",
    feature1Title: "🚀 动态查询",
    ...
    feature4Title: "♿ 可访问",
    feature4Desc: "符合WCAG 2.1 AA标准，支持完整的键盘导航",
    feature5Title: "🎨 Lightning设计",
    feature5Desc: "使用Salesforce Lightning Design System构建",
    feature6Title: "🧪 已测试",
