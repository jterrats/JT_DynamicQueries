...
console.log(`// Import Custom Labels from Salesforce Translation Workbench (${uniqueLabels.length} labels)`);
uniqueLabels.forEach(label => {
  console.log(`import ${label}Label from "@salesforce/label/c.JT_${componentName}_${label}";`);
});
