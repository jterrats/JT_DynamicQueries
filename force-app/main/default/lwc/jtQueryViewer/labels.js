...
const LABELS = {
    'en': {
        ...
        runAsNote: 'Note: This validates user permissions but executes with USER_MODE security. Results reflect sharing rules and field-level security.',
        ...
        predefinedBindingsDesc: 'This configuration has predefined bindings that will be used automatically.',
        results: 'Results',
        records: 'records',
        record: 'record',
        showing: 'Showing',
        ...
        createConfigTooltip: 'Create a new query configuration with a SOQL query (SELECT fields FROM object WHERE condition), optional bind variables in JSON format, and field mappings.',
        sandboxOnlyWarning: 'Only available in Sandbox/Scratch/Developer Orgs. Use Setup UI in Production.',
        whereIsThisUsed: 'Where is this used?',
        whereIsThisUsedTooltip: 'Find where this configuration is used in Apex code',
        findingUsage: 'Searching Apex classes...',
        usageModalTitle: 'Where is "{0}" used?',
        usageModalSubtitle: 'Searching Apex classes for references to this configuration',
        foundReferences: 'Found {0} reference(s) in Apex code',
        noUsageFound: 'No usage found',
        noUsageMessage: 'This configuration is not currently referenced in any Apex class',
    ...
    'es': {
        ...
        runAsNote: 'Nota: Esto valida permisos de usuario pero ejecuta con seguridad USER_MODE. Los resultados reflejan reglas de uso compartido y seguridad a nivel de campo.',
        ...
        predefinedBindingsDesc: 'Esta configuración tiene enlaces predefinidos que se usarán automáticamente.',
        results: 'Resultados',
        records: 'registros',
        record: 'registro',
        showing: 'Mostrando',
        ...
        createConfigTooltip: 'Crea una nueva configuración de consulta con una consulta SOQL (SELECT campos FROM objeto WHERE condición), variables de enlace opcionales en formato JSON y mapeos de campos.',
        sandboxOnlyWarning: 'Solo disponible en Sandbox/Scratch/Developer Orgs. Use la UI de Configuración en Producción.',
        whereIsThisUsed: '¿Dónde se usa esto?',
        whereIsThisUsedTooltip: 'Encuentra dónde se usa esta configuración en código Apex',
        findingUsage: 'Buscando en clases Apex...',
        usageModalTitle: '¿Dónde se usa "{0}"?',
        usageModalSubtitle: 'Buscando referencias a esta configuración en clases Apex',
        foundReferences: 'Se encontraron {0} referencia(s) en código Apex',
        noUsageFound: 'No se encontró uso',
        noUsageMessage: 'Esta configuración no está referenciada en ninguna clase Apex actualmente',
    ...
    'fr': {
        ...
        runAsNote: 'Note: Ceci valide les autorisations utilisateur mais s\'exécute avec la sécurité USER_MODE. Les résultats reflètent les règles de partage et la sécurité au niveau du champ.',
        ...
        predefinedBindingsDesc: 'Cette configuration a des liaisons prédéfinies qui seront utilisées automatiquement.',
        results: 'Résultats',
        ...
        createConfigTooltip: 'Créer une nouvelle configuration de requête avec une requête SOQL (SELECT champs FROM objet WHERE condition), des variables de liaison optionnelles au format JSON et des mappages de champs.',
        sandboxOnlyWarning: 'Disponible uniquement dans Sandbox/Scratch/Developer Orgs. Utilisez l\'interface de configuration en production.',
        whereIsThisUsed: 'Où est-ce utilisé?',
        whereIsThisUsedTooltip: 'Trouver où cette configuration est utilisée dans le code Apex',
        findingUsage: 'Recherche dans les classes Apex...',
        usageModalTitle: 'Où "{0}" est-il utilisé?',
        usageModalSubtitle: 'Recherche de références à cette configuration dans les classes Apex',
        foundReferences: '{0} référence(s) trouvée(s) dans le code Apex',
        noUsageFound: 'Aucune utilisation trouvée',
        noUsageMessage: 'Cette configuration n\'est actuellement référencée dans aucune classe Apex',
    ...
    'de': {
        ...
        runAsNote: 'Hinweis: Dies validiert Benutzerberechtigungen, führt jedoch mit USER_MODE-Sicherheit aus. Ergebnisse spiegeln Freigaberegeln und Feldsicherheit wider.',
        ...
        predefinedBindingsDesc: 'Diese Konfiguration hat vordefinierte Bindungen, die automatisch verwendet werden.',
        results: 'Ergebnisse',
        records: 'Datensätze',
        record: 'Datensatz',
        showing: 'Anzeige',
        ...
        createConfigTooltip: 'Erstellen Sie eine neue Abfragekonfiguration mit einer SOQL-Abfrage (SELECT Felder FROM Objekt WHERE Bedingung), optionalen Bind-Variablen im JSON-Format und Feldzuordnungen.',
        sandboxOnlyWarning: 'Nur verfügbar in Sandbox/Scratch/Developer Orgs. Verwenden Sie die Setup-Oberfläche in der Produktion.',
        whereIsThisUsed: 'Wo wird dies verwendet?',
        whereIsThisUsedTooltip: 'Finden Sie heraus, wo diese Konfiguration im Apex-Code verwendet wird',
        findingUsage: 'Suche in Apex-Klassen...',
        usageModalTitle: 'Wo wird "{0}" verwendet?',
        usageModalSubtitle: 'Suche nach Verweisen auf diese Konfiguration in Apex-Klassen',
        foundReferences: '{0} Verweis(e) im Apex-Code gefunden',
        noUsageFound: 'Keine Verwendung gefunden',
        noUsageMessage: 'Diese Konfiguration wird derzeit in keiner Apex-Klasse referenziert',
